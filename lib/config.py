...
def get_hellar_conf():
    ...
    if sys.platform == 'darwin':
        hellar_conf = os.path.join(home, "Library/Application Support/Hellar/hellar.conf")
    elif sys.platform == 'win32':
        hellar_conf = os.path.join(os.environ['APPDATA'], "Hellar/Hellar.conf")
    else:
        hellar_conf = os.path.join(home, ".hellar/hellar.conf")
