...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to hellard "gobject list" output
    ...
    def hellard_serialise(self):
        import hellarlib
        return hellarlib.SHIM_serialise_for_hellard(self.serialise())
